...
const arr = [];
// for(let i=97; i<122+1;i++){//lowerCase
...
// for (let i = 33; i < 64 + 1; i++) {//symbols+digits
//   arr.push(String.fromCharCode(i));
// }

// for (let i = 123; i < 126 + 1; i++) {
//   //symbols
//   arr.push(String.fromCharCode(i));
// }
// symbolIndexes = [
...
//   [123, 126],
// ];
// for (let sI = 0; sI < symbolIndexes.length; sI++) {
//   for (let i = symbolIndexes[sI][0]; i < symbolIndexes[sI][1] + 1; i++) {
//     // console.log(i);
//     arr.push(String.fromCharCode(i));
//   }
// }
