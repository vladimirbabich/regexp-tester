...
export function Select({ isMultiple, onChange }: any) {
  ...
  const currentFunction = useAppSelector(state=>state.testForm.currentQuestion?.functionName)
  const selectedFunction = useAppSelector(state=>state.testForm.selectedFunction)
